...
## centOS関連
- ■centOS 7用のネットワーク設定
	- [CentOS 7 を VirtualBox にインストールし、Web サーバーの設定を行う(かなり変更点あり)(2014/07/27)](http://fnya.cocolog-nifty.com/blog/2014/07/centos-7-virtua.html)
	- 大分古いので、そろそろ別のソースも確認したほうが良いかも。
...
## bash
- ■公開鍵／秘密鍵を作成
	- `ssh-keygen -t rsa -C <mail_address> -f <key_name>`
...
- ■圧縮／解凍関係
	- tar.gzに圧縮したい
		- `tar cvzf <圧縮ファイル名>.tar.gz 対象ディレクトリ`
	- tar.gzを解凍したい
...
- [■playbookまとめ](http://qiita.com/moriteru@github/items/45d69a5744d658ce5c6e)
